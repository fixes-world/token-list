...
declare module "@onflow/fcl" {
  ...
  // tx checker
  tx.isUnknown = (tx: TransactionStatus) => boolean;
  tx.isPending = (tx: TransactionStatus) => boolean;
  tx.isFinalized = (tx: TransactionStatus) => boolean;
  tx.isExecuted = (tx: TransactionStatus) => boolean;
  tx.isSealed = (tx: TransactionStatus) => boolean;
  tx.isExpired = (tx: TransactionStatus) => boolean;
