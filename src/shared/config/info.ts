const network = import.meta.env.PUBLIC_FLOW_NETWORK ?? "testnet";
...
export default {
  ...
  icon: import.meta.env.PUBLIC_ICON ?? "https://fixes.world/apple-touch-icon.png",
  ...
  github: import.meta.env.PUBLIC_GITHUB ?? "https://github.com/fixes-world/token-list",
  ...
  walletConnectProjectId:
    import.meta.env.PUBLIC_WALLET_CONNECT_PROJECT_ID ?? "779bb5171b7c2aea7b27968a964ce083",
  bloctoProjectId: import.meta.env.PUBLIC_BLOCTO_PROJECT_ID ?? "fcc27ab8-bc8a-4cb5-87ce-3b9c2cc644e9",
};
